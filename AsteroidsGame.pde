...
public void keyPressed() {
  ...
  if (key == 's'){
    ...
    for(int k = 0; k < andy.size(); k++){
      int newX = (int)(Math.random() * 1001);
      int newY = (int)(Math.random() * 1001); 
    ...
    raymond.setX((int)(Math.random() * 1000) + 1);
    raymond.setY((int)(Math.random() * 1000) + 1);
  }
}
